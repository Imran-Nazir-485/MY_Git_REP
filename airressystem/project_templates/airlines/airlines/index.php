                ...
                <div>
                  <div class="radio">
                    <div class="wrapper">
                      ...
                      <span class="left">LocalFlights</span>
                      <!-- <input type="" name="name1"> -->
                      <span class="left"></span> </div>
                  </div>
                  <div class="row"> <span class="left">From</span>
                    <input type="text" class="input"  placeholder="DepartureCity">
                  </div>
                  <div class="row"> <span class="left">To</span>
                    <input type="text" class="input" placeholder="DestinationCity">
                  </div>
                  <div class="wrapper">
                    <div class="col1">
                      <div class="row"> <span class="left">DepDate</span>
                        <input type="date" class="input1" value="" placeholder="DepartureDate">
                      </div>
                      <div class="row"> <span class="left">RetDate</span>
                        <input type="date" class="input1" value=""  placeholder="ReturnDate">
                      </div>
                    </div>
                  ...
                  <input type="submit" name="search" class="button1"  value="Search"  >  
                    <!-- <input type="button1" name="Search"> href="#" class="button1"><strong>Search</strong></a></span> <a href="#" class="link1">More Options</a> -->
                     </div>
                </div>
              </form>
            </div>
