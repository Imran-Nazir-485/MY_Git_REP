...
<title>Update_Flight_Schedule</title>
<body>
...
<br>
<div class="col">
    <input type="submit" class="form-control btn btn-info" value="UPDATE" name="updatefs">
</div>
...
$status=0;
$myquery1 = "SELECT * FROM flightschedule ";
$myresult1 = mysqli_query($myconn,$myquery1);
while($myrow = mysqli_fetch_assoc($myresult1)){
if ($myrow['rid']==$rid) {
...
$retdate=$myrow['returndate'];
header("Location:modifyfs.php?depdate=$depdate&deptime=$deptime&returndate=$retdate&fid=$fid&rid=$rid");
}
